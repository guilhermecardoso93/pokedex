...
export function PokemonDetails() {
  ...
  const pokemonColorBack:any = pokemonSelectedDetails?.types.map((
    type,
  ) => (type.type.name));
  ...
  return (
    <>
      ...
      <Container maxWidth="lg">
        <Card className={styles.PokemonCard} key={pokemonSelectedDetails?.id} style={{
        backgroundColor: setTypeColor(pokemonColorBack),
        color: setTypeColorText(pokemonColorBack),
      }}>
          <Box
