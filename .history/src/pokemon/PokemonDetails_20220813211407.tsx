...
export function PokemonDetails() {
  ...
  const pokemonColor = pokemonSelectedDetails?.types.forEach((types) => (types.type.name[0]))
        ...
        >
          <Box
           ...
           /* style={{
              ...
              color: setTypeColorText()
            }}*/
          >
            <Box>
              <Box display="flex" position="relative"  zIndex={"1"} justifyContent='space-between'>
                <CardActions>
                  <IconButton
