    ...
    <>
      ...
      <Container>
        ...
        <Typography>
          ...
          {pokemonSelectedDetails?.types.map((type) => (<Typography>{type.type.name}</Typography>))}
          ...
          <Box display="flex" flexDirection="row">
            ...
            <Typography> {pokemonSelectedDetails?.height}</Typography>
          </Box>
          <Box display="flex" flexDirection="row">
          <Typography> peso:</Typography>
            <Typography>   {pokemonSelectedDetails?.weight}</Typography>
          </Box>
          <Box display="flex" flexDirection="row">
            <Typography> Abilidades:</Typography>
            {pokemonSelectedDetails?.abilities.map((ability) => (<Typography>{ability.ability.name}</Typography>))}
