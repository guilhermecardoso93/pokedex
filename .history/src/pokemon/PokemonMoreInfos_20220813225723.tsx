...
import { getPokemonEv } from "./services/getPokemonEnv";
...
export function PokemonMoreInfos() {
  ...
  const env = useQuery(`getPokemonEv/${id}`, () => getPokemonEv(id));

  const pokemonSelectedDetails = data
  const pokemonSelectedDetailss = console.log(env);
  /*
  const moves = pokemonSelectedDetails?.evolution
  console.log(moves)*/
